...
const NotFound = () => (
  <div
    style={{
      ...
      textAlign: 'center',
      background: 'linear-gradient(135deg, rgb(255, 255, 255) 0%, rgb(125, 171, 223) 100%)',
  ...
  >
    ...
    <style>{`
      ...
      div:nth-child(1) {
        /* The following CSS uses SCSS-like nesting, which is not valid in plain CSS.
           You need to flatten it for standard CSS: */
      }
